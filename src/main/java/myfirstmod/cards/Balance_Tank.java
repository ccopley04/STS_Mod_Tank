...
public class Balance_Tank extends BaseCard{

    public static final String ID = makeID("Balance");
    ...
    public void use(AbstractPlayer p, AbstractMonster m){
        int amount = 0;
        if(AbstractDungeon.player.getPower("Dexterity") != null){
            amount = AbstractDungeon.player.getPower("Dexterity").amount;
        }
