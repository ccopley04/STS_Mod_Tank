...
public class Earthquake_Tank extends BaseCard {
    public static final String ID = makeID("Earthquake");
    ...
    public void use(AbstractPlayer p, AbstractMonster m){
        for(AbstractMonster mo : AbstractDungeon.getCurrRoom().monsters.monsters) {
            this.addToBot(new ApplyPowerAction(mo, p, new BlockReturnPower(mo, this.magicNumber), this.magicNumber, true, AbstractGameAction.AttackEffect.NONE));
        }
    }
}