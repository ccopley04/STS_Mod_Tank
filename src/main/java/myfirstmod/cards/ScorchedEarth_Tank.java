...
public class ScorchedEarth_Tank extends BaseCard {
    public static final String ID = makeID("Scorched Earth");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new HealAndExhaustAction(99, false, true, true, this.magicNumber));
    }
}
