...
public class AnAppleADay_Tank extends BaseCard{

    public static final String ID = makeID("An Apple A Day");
    ...
    public void use(AbstractPlayer p, AbstractMonster m){
        addToBot(new AppleAction(p, this.freeToPlayOnce, this.energyOnUse));
    }
}
