...
public class Pacifism_Tank extends BaseCard {
    public static final String ID = makeID("Pacifism");
    ...
    public void use(AbstractPlayer p, AbstractMonster m){
        this.addToBot(new ApplyPowerAction(p, p, new PacifismPower(p, this.block), this.block));
    }
}