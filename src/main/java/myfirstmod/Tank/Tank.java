...
import static myfirstmod.BasicMod.characterPath;
...
public class Tank extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Tank"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass TANK_CHARACTER;
        @SpireEnum(name = "DARK_GREEN_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor DARK_GREEN_COLOR;
        ...
        private static final Color cardColor = new Color(006611);

        //Methods that will be used in the main mod file
        public static void registerColor() {
            BaseMod.addColor(DARK_GREEN_COLOR, cardColor,
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Tank(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
